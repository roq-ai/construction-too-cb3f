...
import { getRentalOrderById, updateRentalOrderById } from 'apiSdk/rental-orders';
...
function RentalOrderEditPage() {
  ...
  const handleSubmit = async (values: RentalOrderInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateRentalOrderById(id, values);
      mutate(updated);
      resetForm();
